...
|Chooses one of reveal.js`' link:{url-revealjs-doc}/themes/[built-in themes].
...
|:revealjsdir:
|<file\|URL>
|Overrides the reveal.js directory.
Example: `../reveal.js` or `https://cdn.jsdelivr.net/npm/reveal.js@6.0.1`.
...
|*default*, linear, grid
|See link:{url-revealjs-doc}/config/[] for details
...
|Regardless of the values, the aspect ratio is preserved when scaling to fit different resolutions.
Defaults to *960*
...
you should take a look at the {url-revealjs-gh}/blob/6.0.1/css/theme/README.md[reveal.js theme documentation].
