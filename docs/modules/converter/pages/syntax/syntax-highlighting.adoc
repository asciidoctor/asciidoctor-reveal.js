...
In other words, if you declare the `source-highlighter` attribute after an empty line it won't activate syntax highlighting.

Reference: xref:asciidoc:document:header.adoc[]
====
[NOTE]
====
