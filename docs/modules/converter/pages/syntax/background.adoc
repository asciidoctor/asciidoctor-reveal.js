...
Slide Three applies the attribute link:{uri-revealjs-doc}#slide-backgrounds[data-background-color] to the `reveal.js` <section> tag.
...
See the link:{uri-revealjs-doc}#image-backgrounds[relevant reveal.js documentation] for details.
...
See link:{uri-revealjs-doc}#video-backgrounds[the relevant reveal.js documentation] for details.
...
See link:{uri-revealjs-doc}#iframe-backgrounds[the relevant reveal.js documentation] for details.
