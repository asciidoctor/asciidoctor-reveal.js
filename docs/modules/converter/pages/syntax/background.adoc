...
See xref:attachment$background-color.adoc[background-color.adoc] for more examples.

=== Using AsciiDoc roles

Using roles respects the AsciiDoc philosophy of separation of content and presentation.
Colors are defined in CSS, and the xref:custom-styles.adoc[`:customcss:` attribute] is used to specify the CSS file to load.
...
Slide Three applies the link:{url-revealjs-doc}/backgrounds/[data-background-color] attribute to the reveal.js `<section>` tag.
...
See the link:{url-revealjs-doc}/backgrounds/[relevant reveal.js documentation] for details.
...
See link:{url-revealjs-doc}/backgrounds/[the relevant reveal.js documentation] for details.
