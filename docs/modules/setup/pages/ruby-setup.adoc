...
. Create your content in a file with the `.adoc` extension.
See the examples on the xref:converter:features.adoc[Write Your Presentation] page to get started.

. Generate HTML presentation from the AsciiDoc source

  $ bundle exec asciidoctor-revealjs \
    -a revealjsdir=https://cdn.jsdelivr.net/npm/reveal.js@6.0.1 \
    presentation.adoc
