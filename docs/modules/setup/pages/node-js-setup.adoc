...
We recommend installing the dependencies in a project directory, such as the directory where your AsciiDoc presentations are stored.
...
You can now open the `presentation.html` file in your browser.
