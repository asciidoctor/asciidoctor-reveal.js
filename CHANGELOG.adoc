...
Enhancements::
  ...
  * Added `revealjs_disablelayout` attribute to disable layout ({uri-issue}381[#381])
  * Added support for Font Awesome icon sets using the `set`.
    For instance: `icon:font-awesome-flag[set=fab]` ({uri-issue}393[#393])
  * Upgraded Font Awesome to 5.15.1
  * Introduced an attribute to configure Font Awesome version `font-awesome-version` ({uri-issue}392[#392])
  * Added support for data attributes using AsciiDoc attributes prefixed by `data-` ({uri-issue}241[#241])
...
Compliance::
  * Added support for footnotes ({uri-issue}30[#30])
  * Added support for built-in text alignments: `text-left`, `text-right`, `text-center` and `text-justify` {uri-issue}380[#380]
...
Bug Fixes::
  * Fixed a padding issue in _columns layout_ ({uri-issue}372[#372])
...
* Released by: https://github.com/mogztter[Guillaume Grossetie]

{uri-repo}/releases/tag/v4.1.0[git tag] |
{uri-repo}/compare/v4.0.1...v4.1.0[full diff] |
{uri-repo}/milestone/11[milestone]

=== Credits

Thanks to the following people who contributed to this release:

https://github.com/akosma[Adrian Kosmaczewski],
https://github.com/mojavelinux[Dan Allen],
https://github.com/mogztter[Guillaume Grossetie],
https://github.com/obilodeau[Olivier Bilodeau] and
https://github.com/rquinio[Romain Quinio]
