...
Enhancements::
  * Support for Asciidoctor 1.5.6 ({uri-issue}132[#132], {uri-issue}136[#136])
...
Infrastructure::
  * https://github.com/asciidoctor/asciidoctor-doctest[Asciidoctor-doctest] integration.
    This layer of automated testing should help prevent regressions and improve our development process. ({uri-issue}116[#116]).
