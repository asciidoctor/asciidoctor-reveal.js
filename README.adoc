...
More details on that topic can be found link:docs/modules/project/pages/hacking.adoc#node-binary-compatibility[in the development guide].
...
We are interested!
Developer-focused documentation is link:docs/modules/project/pages/hacking.adoc[over here].
