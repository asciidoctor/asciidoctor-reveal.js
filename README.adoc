...
See the https://github.com/hakimel/reveal.js/#image-backgrounds[
reveal.js' documentation] for details.

NOTE: Background images file names are now relative to the `:imagedir:`
attribute if set.

NOTE: The `canvas` keyword can be used instead of `background` for the same
effect.
...
image::https://upload.wikimedia.org/wikipedia/commons/b/b2/Hausziege_04.jpg[canvas,
size=contain]
----
...
See https://github.com/hakimel/reveal.js/#slide-transitions[reveal.js'
