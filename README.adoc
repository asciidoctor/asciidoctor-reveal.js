...
gem 'asciidoctor-revealjs', github: 'asciidoctor/asciidoctor-reveal.js', branch: 'revealjs-backend'
----
+
...
Reveal.js supports a https://github.com/hakimel/reveal.js/#slide-states[data-state] tag that can be added on slides which gets rendered into `<section>` tags.
