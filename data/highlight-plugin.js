 ...
 * Shared with the Ruby implementation; see lib/asciidoctor_revealjs/highlightjs.rb.
 * Adapted from the reveal.js ES module (plugin/highlight/plugin.js) into a plain
 * script: `hljs` is already a global (loaded from the CDN before this script
 * runs) and the plugin registers itself with the `Reveal` global directly,
 * since this file is inlined into the page rather than loaded as a module.
 */
(function() {
	...
	Reveal.registerPlugin( 'highlight', Plugin );
